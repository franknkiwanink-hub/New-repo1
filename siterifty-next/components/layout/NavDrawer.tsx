  ...
  return (
    <nav id="navDrawer">
      <div className="nav-head">
        ...
        <button className="nav-close" id="navCloseBtn" aria-label="Close menu">
          &times;
        </button>
      </div>
      <div id="navScrollBody">
        ...
        <div className="nav-section" id="navAccountLoggedOut">
          ...
          <div className="nav-locked-cta">
            ...
            <button id="navLoginBtn" onClick={openAuthModal}>Log in / Sign up</button>
          </div>
        </div>
        )}
        ...
        <div className="nav-section" id="navAccountLoggedIn">
          ...
          <div className="nav-user-card">
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 7, flexWrap: "wrap" }}>
                ...
                <button className="nav-my-profile-btn" id="navManageProfileBtn">
                  My Profile
                </button>
              </div>
          ...
          <div className="nav-stat-row">
            ...
            <button className="nav-stat-cta cta-topup">
          ...
          <div className="nav-stat-row">
            <span className="nav-stat-label">
              Listings<span className="nav-stat-val" id="navListingsCount">{"\u2014"}</span>
            </span>
            <button className="nav-stat-cta cta-list">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
                <path
          ...
          <div className="nav-stat-row">
            <span className="nav-stat-label">
              Plan<span className="nav-stat-val" id="navPlanName">{(profile?.plan || "free").replace(/^\w/, (c) => c.toUpperCase())}</span>
            </span>
            <button className="nav-stat-cta cta-plan-upgrade" id="navPlanCta">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2">
                <path
          ...
          <button className="nav-link" id="navSettingsBtn" style={{ marginTop: 8 }}>
          ...
          <button className="nav-link" id="navChangeThemeBtn" style={{ marginTop: 2 }}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
        ...
        <div className="nav-section">
          ...
          <a href="#" className="nav-link" id="navMarketplaceLink">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
          ...
          <a href="#" className="nav-link" id="navStartSellingLink">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
              <path d="M12 2l3.5 7 7.5 1-5.5 5 1.5 7.5L12 18.5 5 22.5l1.5-7.5L1 8l7.5-1z" />
            </svg>
            Start Selling
          </a>
          <div className="nav-link nav-notif-row" id="navNotifRow">
            <svg
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
            ...
            <div className="nav-notif-toggle" id="navNotifToggle" role="switch" aria-checked="false">
              <div className="nav-notif-thumb" id="navNotifThumb" />
            </div>
          </div>
          <div className="nav-notif-status" id="navNotifStatus" />
        </div>

        <div className="nav-section">
          <div className="nav-section-title">Support</div>
          <a href="#" className="nav-link" id="navAboutLink">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
          ...
          <a href="#" className="nav-link" id="navContactLink">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
              <path d="M4 4h16v12H7l-3 3V4z" />
            </svg>
            Contact Us
          </a>
          <a href="#" className="nav-link" id="navHelpLink">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
              <circle cx="12" cy="12" r="10" />
          ...
          <a href="#" className="nav-link" id="navHowItWorksLink">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
              <circle cx="12" cy="12" r="10" />
          ...
          <a href="#" className="nav-link" id="navEscrowLink">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
          ...
          <a href="#" className="nav-link" id="navBuyerProtectionLink">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
          ...
          <a href="#" className="nav-link" id="navTermsLink">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
